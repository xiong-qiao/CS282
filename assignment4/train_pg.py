...
class Agent(object):
    ...
    def policy_forward_pass(self, sy_ob_no):
        ...
        if self.discrete:
            ...
            # START OF YOUR CODE
            # ------------------------------------------------------------------
            sy_logits_na = build_mlp(sy_ob_no, self.ac_dim, "pf_discrete", self.n_layers, self.size)
            # ------------------------------------------------------------------
            # END OF YOUR CODE
            # ------------------------------------------------------------------
            return sy_logits_na
            ...
            # START OF YOUR CODE
            # ------------------------------------------------------------------
            sy_mean = build_mlp(sy_ob_no, self.ac_dim, "pf_continuous", self.n_layers, self.size)
            sy_logstd = tf.get_variable(name='logstd', shape=[1, self.ac_dim], dtype=tf.float32)
            # ------------------------------------------------------------------
            # END OF YOUR CODE
            # ------------------------------------------------------------------
    ...
    def sample_action(self, policy_parameters):
        ...
        if self.discrete:
            ...
            # sy_sampled_ac = dist.sample(sample_shape=[batch_size])
            ...
            # sy_sampled_ac = sy_mean + sy_logstd * dist.sample(sample_shape=tf.shape(sy_mean))
    ...
    def sample_trajectory(self, env, animate_this_episode):
        ...
        while True:
            ...
            # START OF YOUR CODE
            # ------------------------------------------------------------------
            # ac = sample_action(self.policy_parameters)
        ...
        if self.reward_to_go:
            ...
            for re in re_n:
                ...
                for i in range(len(re)):
                    ret_tau += (self.gamma ** i) * re[i]
                q = np.ones(shape=[len(re)]) * ret_tau
                q_n.extend(q)
        # ------------------------------------------------------------------
        # END OF YOUR CODE
        # ------------------------------------------------------------------
    ...
    def update_parameters(self, ob_no, ac_na, q_n, adv_n):
        ...
        # print("before_loss: %s\t after_loss: %s" % (before_loss, after_loss))
        # ------------------------------------------------------------------
        # END OF YOUR CODE
        # ------------------------------------------------------------------
