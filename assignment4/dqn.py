...
class QLearner(object):
    ...
    def __init__(self,
        ...
        self.total_error = tf.reduce_mean(huber_loss(self.rew_t_ph + (1 - self.done_mask_ph) * gamma * tf.stop_gradient(self.target_action) 
    ...
    def step_env(self):
        ...
        # make the dim aligned with the batch size
    ...
    def update_model(self):
        ...
        if (self.t > self.learning_starts and \
            ...
            # 3.b initializ the network and update the target newtwork
            if not self.model_initialized:
                self.session.run(tf.variables_initializer(tf.global_variables()), {self.obs_t_ph: obs_batch, 
